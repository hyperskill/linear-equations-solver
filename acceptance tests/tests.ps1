...
Describe JavaAcceptanceTests { 
    It 'single solution' { 
        ...
        java -classpath "../out/production/project" solver.Main -in in.txt -out out.txt -verbose > "$PSScriptRoot/stdout.txt"
    ...
    It 'no solution' { 
        ...
        java -classpath "../out/production/project" solver.Main -in in1.txt -out out1.txt -verbose > "$PSScriptRoot/stdout1.txt"
    ...
    It 'many solutions' { 
        ...
        java -classpath "../out/production/project" solver.Main -in in2.txt -out out2.txt -verbose > "$PSScriptRoot/stdout2.txt"
    ...
    It 'single solution complex numbers' { 
        ...
        java -classpath "../out/production/project" solver.Main -in in3.txt -out out3.txt -verbose > "$PSScriptRoot/stdout3.txt"
    ...
    It 'no output without -verbose' { 
        ...
        java -classpath "../out/production/project" solver.Main -in in.txt -out out4.txt > "$PSScriptRoot/stdout4.txt"
