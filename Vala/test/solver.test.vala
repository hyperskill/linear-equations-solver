...
void solve9_solver_test()
{
    try
    {
        ...
        ComplexNumber[] expected_partial_solution = new ComplexNumber[] {new ComplexNumber (9.0, 0), new ComplexNumber (0, 0), new ComplexNumber (0, 0)};
        NumberSolutions expected_number_solutions = NumberSolutions.MANY;
...
void solve10_solver_test()
{
    try
    {
        ...
        ComplexNumber[] expected_partial_solution = new ComplexNumber[] {new ComplexNumber (-8.3333333, 0),
                          new ComplexNumber (0, 0), new ComplexNumber (-0.6666667, 0), new ComplexNumber (1.6666667, 0)
        };
        NumberSolutions expected_number_solutions = NumberSolutions.MANY;
...
void solve12_solver_test()
{
    try
    {
        ...
        ComplexNumber[] expected_partial_solution = new ComplexNumber[] {new ComplexNumber (6.73335286, -22.99754223), new ComplexNumber (-1.7976071, 2.08404919), new ComplexNumber (15.69938581, 7.3960106)};
        NumberSolutions expected_number_solutions = NumberSolutions.ONE;
        string[] ? expected_general_solution = null;
